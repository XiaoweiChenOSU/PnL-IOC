function [R_wc,t_wc, aPointsCh, Oaerrs] = PnL_IOCReal3nr(p1,p2,W1,W2,C_truth)
% ,minErr 
% P1N_w = [W1 W2];
...
%             [solutionA, errA] = CopyRefineGaussNewtonForApoints(s,EEA,GGA);
            ...
            [solutionA, errA] = CopyRefineGaussNewtonForApoints(s,EEA,GGA,CCA,pn1,pn2,Pn1_w1,Pn2_w1);
