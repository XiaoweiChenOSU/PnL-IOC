function [RR,tt,err]=RPnL0(p1,p2,P1_w, P2_w)
...
for rootId = 1 : numOfRoots
    ...
    if cT(1) < ceil(P1_w(1,1)) || cT(2) < ceil(P1_w(1,2)) || cT(3) < ceil(P1_w(1,3)) || cT(1) > ceil(P1_w(3,1)) || cT(2) >  ceil(P1_w(3,1)) || cT(3) > ceil(P1_w(2,2)) 
       continue;
    end
