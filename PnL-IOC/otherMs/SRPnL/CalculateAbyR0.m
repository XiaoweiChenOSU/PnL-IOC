function aPoints = CalculateAbyR0(p1, p2, W1, W2, Rr)
    ...
    for i = 1:4
        ...
        MatN(i, 6) = nyi;
        MatN(i, 7) = nzi;
        MatN(i, 8) = ((P1N_w(1,i)+P2N_w(1,i))*(nxi*Rw_c(1,1)+nyi*Rw_c(2,1)+nzi*Rw_c(3,1))) + ((P1N_w(2,i)+P2N_w(2,i))*(nxi*Rw_c(1,2)+nyi*Rw_c(2,2)+nzi*Rw_c(3,2))) + P1N_w(3,i)*(nxi*Rw_c(1,3)+nyi*Rw_c(2,3)+nzi*Rw_c(3,3))/2;      
    end
