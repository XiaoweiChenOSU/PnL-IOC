...
function [ R_wc,T,Oerrs] = APSRPnLMCMC(p1,p2,W1,W2,cH,IA)
...
%calculate the first parameter for R;
Vw=W2-W1;
Vw = xnorm(Vw);
Pw = (W1 + W2) * 0.5;
...
%         curErr = getErr(pn1,pn2,Pn1_w1,Pn2_w1,Rr,Rt);       
...
Oerrs = minErr;
% 
% Oerrs = getErr(p1,p2,W1,W2,R_wc,Rt);
