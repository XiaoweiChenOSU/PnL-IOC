function [R, T, minerr,aPointsN] = PnL_IOC0(p1, p2, P1_w, P2_w)
...
%     minerr = Inf;
    ...
    [tR0, tT0, errt] = RSPnL_(p1, p2, P1_w, P2_w);  
...
%     aPoints = Copy_of_CalculateAbyR01(p1, p2, P1_w, P2_w, tR);
   aPoints = Copy_of_CalculateAbyR0(p1, p2, P1_w, P2_w, tR);
...
%        aPointsN = Copy_of_CalculateAbyR0(p1, p2, P1_w, P2_w, R);
%    end
...
%      P2N_w = [W2 W2(:,6:8) W2(:,5)];
% 
%      [tR, tT, minerr] = RPnL0(pn1(1:2,:), pn2(1:2,:), P1N_w, P2N_w);
%      
     solutionO = [Cayley(tR);aPoints];
    
     [EEA, GGA, CCA] = Copy_of_RefineEquA0(p1, p2, P1_w, P2_w,solutionO,tT);
%   
     solution = Copy_of_RefineGaussNewtonRandApT0(solutionO,EEA,GGA, CCA, p1, p2, P1_w, P2_w);
...
%     sr=[1,s1,s2,s3,s4,s5,s6,s7,s8,s9,...
...
%         if cT(1) < ceil(P1_w(1,1)) || cT(2) < ceil(P1_w(2,1)) || cT(3) < ceil(P1_w(3,1)) || cT(1) > ceil(P1_w(1,3)) || cT(2) >  ceil(P1_w(1,3)) || cT(3) > ceil(P1_w(2,2)) 
%            continue;
%         end
