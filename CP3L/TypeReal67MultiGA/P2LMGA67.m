function [F1, G] = P2LMGA67(xsA, xeA, Pn1_wA, Pn2_wA, xsB, xeB, Pn1_wB, Pn2_wB, xsC, xeC, Pn1_wC, Pn2_wC, xsD, xeD, Pn1_wD, Pn2_wD,  A, C_truth, Lheight)
...
%   Po (P) evaluation
%-----------------------------------------
P = EvaluationNSGA267(Po,GAParameters,ProblemParameters);
...
%     Mutants = [Mutants;SelCh];
    ...
    Mutants = EvaluationNSGA267(Mutants,GAParameters,ProblemParameters);
