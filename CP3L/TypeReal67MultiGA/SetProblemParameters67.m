...
function ProblemParameters = SetProblemParameters67(GAParameters)
...
%     ProblemParameters.s4LowerLimit = Height/2;
    ...
    ProblemParameters.s1UpperLimit = W1(1,n)+Height/2;
    ProblemParameters.s1LowerLimit = W1(1,n)-Height/2;
    ProblemParameters.s2UpperLimit = W1(2,n)+Height/2;
    ProblemParameters.s2LowerLimit = W1(2,n)-Height/2;
    ProblemParameters.s3UpperLimit = W2(1,n)+Height/2;
    ProblemParameters.s3LowerLimit = W2(1,n)-Height/2;
    ProblemParameters.s4UpperLimit = W2(2,n)+Height/2;
    ProblemParameters.s4LowerLimit = W2(2,n)-Height/2;
