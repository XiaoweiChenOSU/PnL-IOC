...
function [P,isValid] = EvaluationNSGA267(Po,GAParameters,ProblemParameters)
...
for i = 1:N
    [P(i).ValObjective,P(i).RA,P(i).RB,P(i).RC,P(i).RD,P(i).TA,P(i).TB,P(i).TC,P(i).TD] = CameraPose67(Po(i).Val,p1A,p2A,W1A,W2A,p1B,p2B,W1B,W2B,p1C,p2C,W1C,W2C,p1D,p2D,W1D,W2D,A,C_truth,unknown);
