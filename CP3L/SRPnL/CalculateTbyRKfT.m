function Rt = CalculateTbyRKfT(p1, p2, W1, W2, C_truth, Rr,unkown)
    ...
    for i = 1:3
        ...
        MatN(i+3, 2) = nyi;
        MatN(i+3, 3) = nzi; 
        MatN(i+3, 4) = (P2N_w(1,i)*(nxi*Rw_c(1,1)+nyi*Rw_c(2,1)+nzi*Rw_c(3,1))) + (P2N_w(2,i)*(nxi*Rw_c(1,2)+nyi*Rw_c(2,2)+nzi*Rw_c(3,2))) + (P2N_w(3,i)*(nxi*Rw_c(1,3)+nyi*Rw_c(2,3)+nzi*Rw_c(3,3)));      
    end
