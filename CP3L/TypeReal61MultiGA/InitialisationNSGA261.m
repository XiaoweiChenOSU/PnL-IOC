...
function Pop = InitialisationNSGA261(individuVide, ProblemParameters,GAParameters)
...
%         Pop(i).Val(2) = Pop(i).Val(1)+ ceil(Lheight/3)*(rand(1,1)-0.5);
%         if Pop(i).Val(2) > s2U
%             Pop(i).Val(2) = s2U;
%         elseif Pop(i).Val(2) < s2L
%             Pop(i).Val(2) = s2L;
%         end
        Pop(i).Val(3) = s3L+(s3U-s3L)*rand(1,1);
        Pop(i).Val(4) = s4L+(s4U-s4L)*rand(1,1);

%         Pop(i).Val(4) = Pop(i).Val(3) + ceil(Lheight/3)*(rand(1,1)-0.5);
%         if  Pop(i).Val(4) < s4L
%             Pop(i).Val(4) = s4L;
%         elseif Pop(i).Val(4) > s4U
%             Pop(i).Val(4) = s4U;
%         end
        
%         Pop(i).Val(1) = Pop(i).Val(1)*25;
%         Pop(i).Val(2) = Pop(i).Val(2)*25;
%         Pop(i).Val(3) = Pop(i).Val(3)*25;
%         Pop(i).Val(4) = Pop(i).Val(4)*25;
%         
