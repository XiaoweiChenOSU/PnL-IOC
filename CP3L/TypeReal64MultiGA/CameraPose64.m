...
function [f,RA,RB,TA,TB] = CameraPose64(s, T1p1A, T1p2A, Pn1_wA, Pn2_wA, T1p1B, T1p2B, Pn1_wB, Pn2_wB,T1A,C_truth,unknown)
    ...
    Pn2_wA(1,n) =  s(3);
    Pn2_wA(3,n) =  s(2);
    Pn1_wA(1,:) =  Pn2_wA(1,:)-L1;
    Pn2_wA(2,:) =  Pn1_wA(2,:)+L2;

    Pn1_wB(1,n) =  s(1);
    Pn1_wB(2,n) =  s(2);
    Pn1_wB(3,n) =  s(1);
    Pn2_wB(3,n) =  s(2);
    Pn2_wB(1,:) =  Pn1_wB(1,:)+L1;
