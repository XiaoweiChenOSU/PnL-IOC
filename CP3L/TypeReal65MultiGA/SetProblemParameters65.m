...
function ProblemParameters = SetProblemParameters65(GAParameters)
...
%     ProblemParameters.s2LowerLimit = 4*Height/5;
%     ProblemParameters.s3UpperLimit = Height;
%     ProblemParameters.s3LowerLimit = 4*Height/5;

    ProblemParameters.s1UpperLimit = W1(2,n)+Height/5;
    ProblemParameters.s1LowerLimit = W1(2,n)-Height/5;
    ProblemParameters.s2UpperLimit = W2(1,n)+Height/5;
    ProblemParameters.s2LowerLimit = W2(1,n)-Height/5;
    ProblemParameters.s3UpperLimit = W2(2,n)+Height/5;
    ProblemParameters.s3LowerLimit = W2(2,n)-Height/5;
...
%     end
%     
%     if ProblemParameters.s2LowerLimit < Oheiht/2
%         ProblemParameters.s2LowerLimit = Oheiht/2;
%     end
%     if ProblemParameters.s2UpperLimit > Oheiht
%         ProblemParameters.s2UpperLimit = Oheiht;
%     end
