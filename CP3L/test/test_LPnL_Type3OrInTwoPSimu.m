...
% T1p1 = [158.896262050777,147.415138189270;312.971185097641,630.923292305434;344.094746231418,336.821121715122]
% T1p2 = [2.98289673594146,62.6648323909242;313.689388506855,475.924422880694;671.918325791641,223.551045202141]


T1P1_w = [256 256 326;256 115 256;271 250 256];
T1P2_w = [256 256 371;256 160 256;371 250 256];
...
%     T1P1_nw(i,:) = [T1P1_w(i,:) 1] * [1 0 0 0;0 cos(pi/8) sin(pi/8) 0;0 -sin(pi/8) cos(pi/8) 0;0 0 0 1];
%     T1P2_nw(i,:) = [T1P2_w(i,:) 1] * [1 0 0 0;0 cos(pi/8) sin(pi/8) 0;0 -sin(pi/8) cos(pi/8) 0;0 0 0 1];
