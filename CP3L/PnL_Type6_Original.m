...
%         Ttruth = Data{j}.T;
    ...
    %     
        ...
        errBmin = Inf;
        for i = 1:length(F1)
%             if F1(i).ValObjective(1) > 5 || F1(i).ValObjective(2) > 5 || F1(i).ValObjective(3) > 30 || F1(i).ValObjective(4) > 30
...
%             end
        ...
        w=[1,s1,s2,s3,s4,s5,s6,s7,s8,s9,s10,s10*s2,s10*s3,s10*s4,s10*s5,s10*s6,s10*s7,s10*s9,s11,s11*s2,s11*s3,s11*s4,s11*s5,s11*s6,s11*s7,s11*s9,s1^2,s1*s2,s1*s3,s2^2,s2*s3,s3^2]';
