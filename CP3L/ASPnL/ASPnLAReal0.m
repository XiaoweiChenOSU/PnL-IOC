function [R, T, minerr,aPointsN] = ASPnLAReal0(p1, p2, P1_w, P2_w)
...
%     aPoints = Copy_of_CalculateAbyR01(p1, p2, P1_w, P2_w, tR);
   aPoints = CalculateAbyRealR0(p1, p2, P1_w, P2_w, tR);
...
%      
     ...
     [EEA, GGA, CCA] = RefineEquAReal0(p1, p2, P1_w, P2_w,solutionO,tT);
%   
     solution = RefineGaussNewtonRandApRealT0(solutionO,EEA,GGA, CCA, p1, p2, P1_w, P2_w);
