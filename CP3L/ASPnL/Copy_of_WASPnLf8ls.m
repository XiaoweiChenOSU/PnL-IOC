function [R, T, err] = Copy_of_WASPnLf8ls(p1, p2, P1_w, P2_w)
...
% 	p2 = [p2; ones(1,nLine)];
    ...
    for i = 1:4
        ...
        MatN(i, 5) = (nxi*pos(1)+nyi*pos(2)+nzi*pos(3))+((P1N_w(1,j1)+P2N_w(1,j1))*(nxi*Rw_c(1,1)+nyi*Rw_c(2,1)+nzi*Rw_c(3,1))/2)+ ((P1N_w(2,j1)+P2N_w(2,j1))*(nxi*Rw_c(1,2)+nyi*Rw_c(2,2)+nzi*Rw_c(3,2))/2) + P1N_w(3,j1)*(nxi*Rw_c(1,3)+nyi*Rw_c(2,3)+nzi*Rw_c(3,3))/2;
    end
