function [R, err] = ASPnLW(p1, p2, P1_w, P2_w)
...
%	 T: estimated translation
    ...
    [R,R0, err] = RSPnL_(p1, p2, P1_w, P2_w);  
%     R = invertR(R0);
...
function [R,rot_cw,errpro] = RSPnL_(p1,p2,P1_w,P2_w)
...
%         [rot_cw, pos_cw] = invertRT(rot_wc, pos_wc);
        ...
        err = getFirstErr(p1,p2,P1_w,P2_w,rot_wc);
        count = count+1;
        R{count} = rot_wc;
        rot_cw = invertR(rot_wc);
        % xuchi
        conditionErr = err;        
