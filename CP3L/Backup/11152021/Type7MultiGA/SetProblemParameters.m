...
function ProblemParameters = SetProblemParameters()
...
%     ProblemParameters.s4LowerLimit = 16;
    ...
    ProblemParameters.s1UpperLimit = 128;
    ProblemParameters.s1LowerLimit = 1;
    ProblemParameters.s2UpperLimit = 255;
    ProblemParameters.s2LowerLimit = 129;
    ProblemParameters.s3UpperLimit = 255;
    ProblemParameters.s3LowerLimit = 129;
    ProblemParameters.s4UpperLimit = 128;
    ProblemParameters.s4LowerLimit = 1;
