...
function [f,RA,RB,RC,RD,TA,TB,TC,TD] = CameraPose67(s, T1p1A, T1p2A, Pn1_wA, Pn2_wA, T1p1B, T1p2B, Pn1_wB, Pn2_wB, T1p1C, T1p2C, Pn1_wC, Pn2_wC, T1p1D, T1p2D, Pn1_wD, Pn2_wD,cH)
...
%     
    ...
    [RA, TA, errA] = SRPnL61(iT1p1A', iT1p2A', Pn1_wA', Pn2_wA',cH);
    [RB, TB, errB] = SRPnL61(iT1p1B', iT1p2B', Pn1_wB', Pn2_wB',cH);
    [RC, TC, errC] = SRPnL61(iT1p1C', iT1p2C', Pn1_wC', Pn2_wC',cH);
    [RD, TD, errD] = SRPnL61(iT1p1D', iT1p2D', Pn1_wD', Pn2_wD',cH);
