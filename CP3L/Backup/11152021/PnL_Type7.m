...
%     
    ...
    [R3, T3, err] = SRPnL71(ip1A', ip2A', T1P1_wA', T1P2_wA', cH);
    [R4, T4, err4] = SRPnL71(ip1B', ip2B', T1P1_wB', T1P2_wB', cH);
    [R5, T5, err5] = SRPnL7(ip1', ip2', T1P1_w', T1P2_w', cH);
    ...
    tic;
    count = 1;        
    [F1, G] = P2LMGA7(T1p1A, T1p2A, T1P1_wA, T1P2_wA, T1p1B, T1p2B, T1P1_wB, T1P2_wB, cH);
    errmin = Inf;
    Ri = eye(3,3);
    Ti = [0,0,0];
    flag = 0;
...
%         count = count + 1;
    ...
    elseif flag == 2
        ...
        [Rf, Tf, errf] = SRPnL71(ip1B', ip2B', T1P1_wB', T1P2_wB', cH); 
    end
    ...
    [Rtf, Ttf, errftf] = SRPnL71(ip1A', ip2A', T1P1_wA', T1P2_wA', cH);
    Rth{j} = Rtf;
    Tth{j} = Ttf;
    errortf(j) = errftf; 
    errRtf(j) = cal_rotation_err(Rtf,Rtruth);
    errTtf(j) = cal_translation_err(Ttf,Ttruth);
