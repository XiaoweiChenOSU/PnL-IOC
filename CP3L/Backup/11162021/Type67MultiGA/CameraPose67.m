...
function [f,RA,RB,RC,RD,TA,TB,TC,TD] = CameraPose67(s, T1p1A, T1p2A, Pn1_wA, Pn2_wA, T1p1B, T1p2B, Pn1_wB, Pn2_wB, T1p1C, T1p2C, Pn1_wC, Pn2_wC, T1p1D, T1p2D, Pn1_wD, Pn2_wD,cH,T1A, Lheight)
...
%     T1A = [200 0 160;0 200 320;0 0 1];
    ...
    [RC, TC, errC] = SRPnL61(iT1p1C', iT1p2C', Pn1_wC', Pn2_wC',cH, Lheight);
    [RD, TD, errD] = SRPnL61(iT1p1D', iT1p2D', Pn1_wD', Pn2_wD',cH, Lheight);
