...
function ProblemParameters = SetProblemParameters77(GAParameters)
...
%     ProblemParameters.s4LowerLimit = 16;
    ...
    Width = GAParameters.Lwidth;

    ProblemParameters.s1UpperLimit = Width/2;
    ProblemParameters.s1LowerLimit = 0;
    ProblemParameters.s2UpperLimit = Width/2;
    ProblemParameters.s2LowerLimit = 0;
    ProblemParameters.s3UpperLimit = Width;
    ProblemParameters.s3LowerLimit = Width/2;
    ProblemParameters.s4UpperLimit = Width;
    ProblemParameters.s4LowerLimit = Width/2;
