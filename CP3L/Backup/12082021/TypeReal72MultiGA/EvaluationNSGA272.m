...
function [P,isValid] = EvaluationNSGA272(Po,GAParameters)
...
for i = 1:N
    ...
    [P(i).ValObjective,P(i).RA,P(i).RB,P(i).TA,P(i).TB] = CameraPose72(Po(i).Val,p1A,p2A,W1A,W2A,p1B,p2B,W1B,W2B,cH,A, Lheight);
