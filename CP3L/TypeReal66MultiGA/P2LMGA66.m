function [F1, G] = P2LMGA66(xsA, xeA, Pn1_wA, Pn2_wA, xsB, xeB, Pn1_wB, Pn2_wB, A, C_truth, Lheight)
...
%   Po (P) evaluation
%-----------------------------------------
P = EvaluationNSGA266(Po,GAParameters,ProblemParameters);
...
%     Mutants = [Mutants;SelCh];
    ...
    Mutants = EvaluationNSGA266(Mutants,GAParameters,ProblemParameters);
